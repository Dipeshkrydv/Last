...
// No need to mock Op as it is imported directly, let's keep the real one or mock if necessary, we can just use the real one if it works, or mock it correctly.
// For Sequelize, it's better to provide a mock.
jest.mock('sequelize', () => ({
  Op: {
    or: Symbol.for('or'),
