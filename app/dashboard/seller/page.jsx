...
export default function SellerDashboard() {
  ...
  }, [status, router, fetchBooks, session]);
              ...
              >
                ...
                <div className="relative aspect-[3/4] overflow-hidden bg-gray-100">
                  <Image
                    ...
                    layout="fill"
                    objectFit="cover"
                    className="transform group-hover:scale-105 transition duration-700 ease-out"
                  />
        ...
        {modalType === 'delete' ? (
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-gray-100 rounded-xl overflow-hidden aspect-video relative">
              <Image src={getBookImage(selectedBook)} layout="fill" objectFit="cover" alt="Cover" />
            </div>
            <div>
