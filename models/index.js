...
const Book = sequelize.models.Book || sequelize.define('Book', {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
...
const Otp = sequelize.models.Otp || sequelize.define('Otp', {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
  otp: { type: DataTypes.STRING, allowNull: false },
  expiresAt: { type: DataTypes.DATE, allowNull: false },
}, { timestamps: true });

const AutomationLog = sequelize.models.AutomationLog || sequelize.define('AutomationLog', {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
  action: { type: DataTypes.STRING, allowNull: false },
}, { timestamps: true });

const Feedback = sequelize.models.Feedback || sequelize.define('Feedback', {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
...
const City = sequelize.models.City || sequelize.define('City', {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
  name: { type: DataTypes.STRING, allowNull: false },
}, { timestamps: true });

// Define Associations (only if not already defined)
if (!User.associations.books) {
...
export { User, Book, Order, Cart, Message, Otp, AutomationLog, Feedback, City, sequelize as default };
